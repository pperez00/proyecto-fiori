		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsofftekpspproyectos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsofftekpspproyectos-display": {
								"semanticObject": "comsofftekpspproyectos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sofftek.psp.proyectos",
									"url": sap.ui.require.toUrl("com/sofftek/psp/proyectos")
								}
							}
						}
					}
